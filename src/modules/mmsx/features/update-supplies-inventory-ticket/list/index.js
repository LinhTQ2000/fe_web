...
const breadcrumbs = [
  ...
  {
    route: ROUTE.SUPPLIES_INVENTORY.LIST.PATH,
...
const SuppliesInventory = () => {
            ...
            <>
              <IconButton
                onClick={() =>
                  history.push(
                    withSearch(
                      ROUTE.SUPPLIES_INVENTORY.DETAIL.PATH.replace(
                        ':id',
                        `${id}`,
                      ),
                    ),
                ...
                <>
                  <IconButton
                    onClick={() =>
                      history.push(
                        withSearch(
                          ROUTE.SUPPLIES_INVENTORY.EDIT.PATH.replace(
                            ':id',
                            `${id}`,
                          ),
                        ),
  ...
  const renderHeaderRight = () => {
    return (
      <Button
        onClick={() =>
          history.push(withSearch(ROUTE.SUPPLIES_INVENTORY.CREATE.PATH))
        }
        icon="add"
      >
  ...
  return (
    <Page
      ...
      title={t('menu.suppliesInventory')}
    ...
    >
      ...
      />
      <DataTable
        title={t('suppliesInventory.title')}
        columns={columns}

...
function ItemSettingTable({
  ...
  const supplyColumns = [
    ...
    },
    {
      ...
      renderCell: (params, index) => {
        return isDetail ? (
          ...
          <Field.TextField
            name={`items[${index}].supply.exportQuantity`}
            placeholder={t(
    ...
    },
    {
      ...
      headerName: t('warehouseExportTicket.remainQuantity'),
      width: 200,
      renderCell: (params, index) => {
        return isDetail ? (
          params.row?.requestQuantity - params.row?.exportedQuantity || 0
        ) : (
          <Field.TextField
            name={`items[${index}].supply.remainQuantity`}
            placeholder={t('warehouseExportTicket.remainQuantity')}
            type="number"
            disabled
          />
        )
    ...
    {
      field: 'quantity',
      headerName: t('warehouseExportTicket.quantity'),
      width: 200,
      renderCell: (params, index) => {
        return isDetail ? (
          ...
          <Field.TextField
            ...
            placeholder={t('warehouseExportTicket.quantity')}
            type="number"
